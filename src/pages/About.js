        ...
        <div className="container">
            <div className="row justify-content-center mb-30-none">
                <div className="col-sm-6 col-lg-3">
                    <div className="counter-item">
                        <h3 className="counter-header">
                            <span className="title counter">62</span><span className="title">M</span>
                        </h3>
                        <p>ITEMS AUCTIONED</p>
                    </div>
                </div>
                <div className="col-sm-6 col-lg-3">
                    <div className="counter-item">
                        <h3 className="counter-header">
                            <span>$</span><span className="title counter">887</span><span className="title">M</span>
                        </h3>
                        <p>IN SECURE BIDS</p>
                    </div>
                </div>
                <div className="col-sm-6 col-lg-3">
                    <div className="counter-item">
                        <h3 className="counter-header">
                            <span className="title counter">63</span><span className="title">M</span>
                        </h3>
                        <p>ITEMS AUCTIONED</p>
                    </div>
                </div>
                <div className="col-sm-6 col-lg-3">
                    <div className="counter-item">
                        <h3 className="counter-header">
                            <span>0</span><span className="title counter">5</span><span className="title">K</span>
                        </h3>
                        <p>AUCTION EXPERTS</p>
                    </div>
                </div>
