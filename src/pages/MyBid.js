                  ...
                  <div class="content">
                    ...
                    <span class="username">
                      <a
                        ...
                        class="__cf_email__"
                        data-cfemail="81ebeee9efc1e6ece0e8edafe2eeec"
                      >
                        [email&#160;protected]
                      </a>
                    </span>
            ...
            <div class="col-lg-8">
              <div class="dash-bid-item dashboard-widget mb-40-60">
                <div class="header">
                  ...
                  <span class="notify">
                    <i class="flaticon-alarm"></i> Manage Notifications
                  </span>
                </div>
                <ul class="button-area nav nav-tabs">
                  ...
                  <li>
                    <a href="#past" data-toggle="tab" class="custom-button">
                      Past
                    </a>
                  </li>
                </ul>
