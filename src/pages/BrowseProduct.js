    ...
    <div className="product-auction padding-bottom mt-20">
        ...
        <div className="product-header mb-40">
                ...
                <form className="product-search ml-auto">
                    ...
                    <button type="submit"><i className="fas fa-search">
                      <FiSearch/>
                    </i></button>
                </form>
            </div>
            ...
            <ul className="pagination">
                <li>
                    <a href="#0"><i className="flaticon-left-arrow">
                      <HiOutlineArrowNarrowLeft/></i></a>
                </li>
                <li>
                    <a href="#0">1</a>
                </li>
                ...
                <li>
                    <a href="#0"><i className="flaticon-right-arrow">
                      <HiOutlineArrowNarrowRight/></i></a>
                </li>
            </ul>
        </div>
        </div>
